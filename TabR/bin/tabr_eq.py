...
class DEQModel(nn.Module):
    def __init__(self, input_dim, hidden_dim, max_iter=10, tol=1e-5):
...
class Model(nn.Module):
    def __init__(
        ...
        *,
        ...
        # Integrasi DEQ di lapisan akhir
        self.deq_model = DEQModel(d_main, d_block, max_iter=30, tol=1e-2)
